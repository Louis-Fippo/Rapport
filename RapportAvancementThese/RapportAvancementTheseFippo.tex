...
%pour insérer du code R dans un code latex.
\usepackage{Sweave}
...
\newcommand{\thedate}{2014/02/07}
\date{\thedate}
\conference{Thèse}{--- Thèse ---\\Analyse et apprentissage automatique de modèles biologiques à larges échelles à partir des données des séries temporelles}
\title{Rapport d' avancement de la thèse}
...
\medskip
\normalsize
Louis Fippo Fitime$^{1,2}$
\footnotesize

\texttt{louis.fippo-fitime@irccyn.ec-nantes.fr}

%penser à finir ma page perso
...
\section{Rapport du 10 Fevrier 2014/Resultats et analyses des Simulations}
\subsection{Les dernièrres résolutions}
%\input{parts/def_ph.tex}
\subsection{Avancement}
%\input{parts/def_thomas.tex}
\input{parts/avancement020414.tex}
\subsection{Les nouvelles résolutions}
